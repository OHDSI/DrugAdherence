...
SELECT person_id,
        ...
        drug_source_concept_id,
        drug_exposure_start_date,
        CASE WHEN drug_exposure_end_date < DATEADD(day, days_supply, drug_exposure_start_date) THEN DATEADD(day, days_supply, drug_exposure_start_date) ELSE drug_exposure_end_date END drug_exposure_end_date,
        days_supply,
        standard_field
